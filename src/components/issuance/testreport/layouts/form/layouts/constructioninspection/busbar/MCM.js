                                ...
                                index.map(index => (
                                    <Box sx= {{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', margin: '5px 15px', width: '250px' }} key= { index }>
                                        <Box sx= {{ border: 'solid 1px #dcdde1', borderRadius: '5px', padding: '5px 15px', marginRight: '10px', width: '70px' }}>
                                            <Ctrl.TextField name= { `construction_inspection.busbar.crimp.mcm_${index}.num` } sx= {{ minWidth: '70px', maxWidth: '50px' }} 
                                                variant= "standard" fullWidth register= { register(`construction_inspection.busbar.crimp.mcm_${index}.num`) }
                                        ...
                                        <Box sx= {{ border: 'solid 1px #dcdde1', borderRadius: '5px', padding: '5px 15px', marginLeft: '10px', minWidth: '70px', maxWidth: '100%' }}>
                                            <Ctrl.TextField name= { `construction_inspection.busbar.crimp.mcm_${index}.txt` }
                                                variant= "standard" fullWidth register= { register(`construction_inspection.busbar.crimp.mcm_${index}.txt`) }
