                ...
                !isLoad ? 
                                    ...
                                    <Grid item key= { index }>
                                        <Grid container direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 2 }>
                                            ...
                                            <Grid item xs= { 3 } md= { 3 } lg= { 2 }>
                                                <Ctrl.Typography text= { assts.asset_name } color= "#34495e" 
                                            ...
                                            <Grid item lg= { 2 } sx= {{ display: { xs: 'none', lg: 'block' } }}>
                                                <Ctrl.Typography 
                                                    ...
                                                    color= "#34495e" style= {{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%' }} />
                                            </Grid>
                                            <Grid item xs= { 3 } md= { 2 } sx= {{ textAlign: 'center' }}>
                                                <Box sx= {{ display: 'flex', flexDirectin: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                                    <Box sx= {{ margin: '5px' }}>
                                                        <Link to= { `/issuance/assets/form/update/${assts.id}` } style= {{ textDecoration: 'none' }}>
                                                    ...
                                                    <Box sx= {{ margin: '5px' }}>
                                                        <Link to= { `/issuance/assets/form/view/${assts.id}` } style= {{ textDecoration: 'none' }}>
                                                            <Box padding= "8px 10px" color= "#ffffff" bgcolor= "#3498db" 
                                                                borderRadius= "4px" display= "flex" flexDirection= "row" justifyContent= "center" alignItems= "center">
                    ...
                    : (
                        <Grid container direction= "row" justifyContent= "center" alignItems= "center" spacing= { 1 }>
                            <Grid item>
                                <Ctrl.Typography text= "No assigned assets found!" color= "#bdc3c7" style= {{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%' }} />
                            </Grid>
                        </Grid>
                    )
                : (
