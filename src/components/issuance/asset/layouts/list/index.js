        ...
        <Grid container direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 1 }>
                    ...
                    <Grid item xs= { 12 } sm= { 4 } lg= { 3 }>
                        <Link to= "/issuance/assets/form/new" style= {{ textDecoration: 'none' }}>
                            <Box display= "flex" flexDirection= "column" justifyContent= "center" alignItems= "center">
                                <Ctrl.Typography color= "#ffffff" text= "ASSIGN ASSET" 
                    ...
                    <Grid item xs= { 12 } sm= { 4 } lg= { 3 }>
                        <Box sx= {{ backgroundColor: '#00b894', textAlign: 'center', padding: { xs: '10px 12px', sm: '7px 12px', md: '10px 15px' }, borderRadius: '5px' }}>
                            <Export element= {
                                ...
                                data= { assignAssets }
                                column= { assignAssets !== undefined ? Object.keys(assignAssets[0]) : [] } />
                        </Box>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>
                <Grid container direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 1 } sx= {{ marginTop: { xs: 0, sm: '-25px', md: '-30px' } }}>
                    ...
                    <Grid item><Body data= { assignAssets } isLoad= { isLoad } /></Grid>
                </Grid>
            </Grid>
        </Grid>
    );
