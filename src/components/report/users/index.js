...
const Index = () => {
    ...
    useEffect(() => {
        reports(setReport, 'users', setIsLoad);
    }, []);
            ...
            <Box sx= {{ padding: { xs: '0 14px', sm: 0 } }}>
                <Grid container direction= "row"  justifyContent= "space-between" alignItems= "center" spacing= { 1 }>
                    <Grid item xs= { 12 } lg= { 2 }>
                        <Ctrl.Typography text= "User List" 
                    ...
                    <Grid item xs= { 12 } lg= { 10 }>
                        <Grid container direction= "row" justifyContent= "flex-end" alignItems= "center" spacing= { 1 }>
                            <Grid item xs= { 12 } sm= { 4 } lg= { 3 }>
                                <PDF name= "User report" content= { report } logo= {{ img: Logo, w: 10, h: 10, type: 'JPEG' }} 
                            ...
                            <Grid item xs= { 12 } sm= { 4 } lg= { 3 }>
                                <Print name= "User report" content= { () => _print.current } 
                ...
                <Box sx= {{ boxShadow: 2, borderRadius: '5px', overflow: 'hidden' }}>
                    <Paper elevation= { 0 }>
                        <TableContainer ref= { _print }>
                            <Table aria-label= "User" size= "small" sx= {{ minWidth: 650, maxHeight: 500 }} stickyHeader>
                                <Header />
