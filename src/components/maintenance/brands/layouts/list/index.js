        ...
        <Box sx= {{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'stretch', marginBottom: '20px' }}>
                ...
                <Grid container direction= "row"  justifyContent= "space-between" alignItems= "center" spacing= { 1 }>
                    ...
                    <Grid item xs= { 12 } sm= { 10 }>
                        <Grid container direction= "row" justifyContent= "flex-end" alignItems= "center" spacing= { 1 }>
                            ...
                            <Grid item xs= { 12 } sm= { 4 } lg= { 3 }>
                                <Export element= {
                                    <Ctrl.Button color= "excel" disabled= { !((Object.keys(brands)).length !== 0) } text= {
                                    ...
                                    filename= "Brand List"
                                    data= { brands }
                                    column= { brands !== undefined ? (Object.keys(brands)).length !== 0 ? Object.keys(brands[0]) : [] : [] } />
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
            ...
            <Box sx= {{ padding: { xs: '0 14px', sm: '0' } }}>
                <Box sx= {{ boxShadow: 2, borderRadius: '5px', overflow: 'hidden' }}>
                    <Paper elevation= { 0 }>
                        <TableContainer>
                            <Table aria-label= "Brand" size= "small" sx= {{ minWidth: 650 }} stickyHeader>
                                <Header />
                                <Body data= { !isLoad ? brands : [] } />
                            </Table>
                        </TableContainer>
                    </Paper>
                </Box>
