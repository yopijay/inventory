                                ...
                                data.map((ctgry, index) => (
                                    <Grid item key= { index }>
                                        <Grid container direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 2 }>
                                            <Grid item md= { 1 }>
                                                <Ctrl.Typography text= { ctgry.id } color= "#34495e" 
                                            ...
                                            <Grid item md= { 1 }>
                                                <Ctrl.Typography text= { ctgry.category_name } color= "#34495e" 
                                                    style= {{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%' }} />
                                            </Grid>
                                            <Grid item md= { 1 }>
                                            ...
                                            <Grid item md= { 2 }>
                                                <Ctrl.Typography text= { ctgry.date_created } color= "#34495e" 
                                                    style= {{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%' }} />
                                            </Grid>
                                            <Grid item md= { 1 }>
                                                <Grid container direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 1 }>
                                                    <Grid item md= { 5 }>
                                                        <Link to= "/brand/form" style= {{ textDecoration: 'none' }} onClick= { () => { setType('update'); setId(ctgry.id); } }>
                                                    ...
                                                    <Grid item md= { 5 }>
                                                        <Link to= "/brand/form" style= {{ textDecoration: 'none' }} onClick= { () => { setType('view'); setId(ctgry.id); } }>
                                                            <Box padding= "10px 0" color= "#ffffff" bgcolor= "#3498db" 
                                                                borderRadius= "4px" display= "flex" flexDirection= "row" justifyContent= "center" alignItems= "center">
